---
title: 'Illustrated Diff Algorithm'
date: 2024-1-22
lastmod: '2024-1-22'
tags: ['React', 'Behind The Scene', 'Tutorial']
draft: false
summary: 'A visual explanation of the diff algorithm used in React and other front-end frameworks, highlighting its limitations and key principles.'
layout: PostSimple
---
...
- 更新后有多个元素，此时就会遍历 `newChild` 创建对应的 `wipFiberNode` 已经它的兄弟元素，此时对应的流程就是多节点 `diff`
...
![Illustrated-React-Diff-Algorithm-1](/static/images/React/Illustrated-React-Diff-Algorithm/Illustrated-React-Diff-Algorithm-1.png)

继续往后面走，发现 `div.key.b` 也能够复用

![Illustrated-React-Diff-Algorithm-2](/static/images/React/Illustrated-React-Diff-Algorithm/Illustrated-React-Diff-Algorithm-2.png)

接下来继续往后面走，`div.key.e`，这个时候发现 `key` 不一样，因此第一轮遍历就结束了

![Illustrated-React-Diff-Algorithm-3](/static/images/React/Illustrated-React-Diff-Algorithm/Illustrated-React-Diff-Algorithm-3.png)
...
![Illustrated-React-Diff-Algorithm-4](/static/images/React/Illustrated-React-Diff-Algorithm/Illustrated-React-Diff-Algorithm-4.png)
...
![Illustrated-React-Diff-Algorithm-5](/static/images/React/Illustrated-React-Diff-Algorithm/Illustrated-React-Diff-Algorithm-5.png)
...
![Illustrated-React-Diff-Algorithm-6](/static/images/React/Illustrated-React-Diff-Algorithm/Illustrated-React-Diff-Algorithm-4.png)
...
![Illustrated-React-Diff-Algorithm-7](/static/images/React/Illustrated-React-Diff-Algorithm/Illustrated-React-Diff-Algorithm-7.png)
...
![Illustrated-React-Diff-Algorithm-8](/static/images/React/Illustrated-React-Diff-Algorithm/Illustrated-React-Diff-Algorithm-8.png)

接下来会继续去遍历剩下的 JSX 对象数组，遍历的同时，从 `map` 里面去找有没有能够复用
![Illustrated-React-Diff-Algorithm-9](/static/images/React/Illustrated-React-Diff-Algorithm/Illustrated-React-Diff-Algorithm-9.png)
...
![Illustrated-React-Diff-Algorithm-10](/static/images/React/Illustrated-React-Diff-Algorithm/Illustrated-React-Diff-Algorithm-10.png)
...
![Illustrated-React-Diff-Algorithm-11](/static/images/React/Illustrated-React-Diff-Algorithm/Illustrated-React-Diff-Algorithm-11.png)
