---
title: 'beginWork Workflow'
date: 2024-1-12
lastmod: '2024-1-12'
tags: ['React', 'Behind The Scene', 'Tutorial']
draft: false
summary: 'Exploring beginWork role in generating and updating FiberNodes during rendering.'
layout: PostSimple
---
...
![beginWork-Workflow-1](/static/images/React/beginWork-Workflow/beginWork-Workflow-1.png)
...
![beginWork-Workflow-2](/static/images/React/beginWork-Workflow/beginWork-Workflow-2.png)
...
- `FC(Function Component) `在 `mount` 的时候，对应的 `tag` 为 `IndeterminateComponent`，在 `update` 的时候就会进入 `FunctionComponent`
- `HostText` 表示的是文本元素
