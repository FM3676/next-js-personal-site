---
title: 'Lane Model in React'
date: 2024-1-25
lastmod: '2024-1-25'
tags: ['React', 'Behind The Scene', 'Tutorial']
draft: false
summary: 'Overview of the lane model in React and its significance in prioritizing updates.'
layout: PostSimple
---
...
> <a href="./Understanding-React-Delayed-Task-Scheduling" title="Understanding React Delayed Task Scheduling">Understanding React Delayed Task Scheduling</a>

> <a href="./React-Scheduler-Task-Scheduling" title="React Scheduler Task Scheduling">React Scheduler Task Scheduling</a>
...
![Lane-Model-in-React-1](/static/images/React/Lane-Model-in-React/Lane-Model-in-React-1.png)

但是此时就会存在一个问题，如何将某一范围的某几个优先级划为同一批？

![Lane-Model-in-React-2](/static/images/React/Lane-Model-in-React/Lane-Model-in-React-2.png)
